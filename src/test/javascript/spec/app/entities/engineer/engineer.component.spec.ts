...
import { EngineerComponent } from 'app/entities/engineer/engineer.component';
...
describe('Component Tests', () => {
  describe('Engineer Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.engineers && comp.engineers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
