package com.appservices.qmmigration.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.appservices.qmmigration.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.appservices.qmmigration.repository.UserRepository.USERS_BY_EMAIL_CACHE);
